...
Seminar talk, written summary and companion code on **proper scoring rules** —
the theory of how to evaluate forecasts that come as full probability
distributions rather than point predictions.

Prepared by **Loay Hefni** and **Jonas Persé** for the *Uncertainty in Machine
Learning* seminar (TU Berlin, talk given 27 November 2025). The material
follows Gneiting & Raftery's classic paper
...
All figures are generated by [code/visualize_theory.py](code/visualize_theory.py)
— run it yourself with `python code/visualize_theory.py`.
